                                              ...
                                              uchar const *row_start, uchar const **row_end)
{
  ...
  */
  ...
  error = unpack_row_old(const_cast< Relay_log_info * >(rli), table, m_width, m_after_image, row_start, &m_cols,
                         row_end, &m_master_reclength, table->write_set, binary_log::PRE_GA_UPDATE_ROWS_EVENT);
