  ...
  if (query_start_arg)
  {
    ...
    */
    ...
    calc_time_from_sec(&t,
                       static_cast< long >(min((longlong)(query_utime / 1000000), (longlong)TIME_MAX_VALUE_SECONDS)),
                       query_utime % 1000000);
...
bool log_slow_applicable(THD *thd)
{
  ...
  */
  ...
  if (unlikely(thd->is_error()) && (unlikely(thd->get_stmt_da()->mysql_errno() == ER_PARSE_ERROR)))
    DBUG_RETURN(false);
