...
template < typename T >
Gis_wkb_vector< T >::Gis_wkb_vector(const void *ptr, size_t nbytes, const Flags_t &flags, srid_t srid,
                                    bool is_bg_adapter)
...
template Gis_wkb_vector< Gis_line_string >::Gis_wkb_vector(void const *, size_t, Geometry::Flags_t const &, srid_t,
                                                           bool);
